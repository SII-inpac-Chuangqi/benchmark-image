...
Decay_H = Decay(name = 'Decay_H',
                ...
                partial_widths = {(P.W__minus__,P.W__plus__):'(((3*ee**4*vev**2)/(4.*sw**4) + (ee**4*MH**4*vev**2)/(16.*MW**4*sw**4) - (ee**4*MH**2*vev**2)/(4.*MW**2*sw**4))*cmath.sqrt(MH**4 - 4*MH**2*MW**2))/(16.*cmath.pi*abs(MH)**3)',
                                  ...
                                  (P.u,P.u__tilde__): '((-12*MU**2*yu**2 + 3*MH**2*yu**2)*cmath.sqrt(-4*MU**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  (P.d,P.d__tilde__): '((-12*MD**2*yd**2 + 3*MH**2*yd**2)*cmath.sqrt(-4*MD**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  (P.s,P.s__tilde__): '((-12*MS**2*ys**2 + 3*MH**2*ys**2)*cmath.sqrt(-4*MS**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
